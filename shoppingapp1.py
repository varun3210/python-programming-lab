...
while 1:
    ...
    title = "flipzon"                                          #gives the title to the msg box
    ...
    title = "Please Confirm"                                 #gives the title to the msg box
    if choice=="Mobiles":
    	...
    	title= "flipzon's Clothes section"                         #gives the title to the msg box
        ...
        msg="Which object?"
    	title= "flipzon's kitchen section"                              #gives the title to the msg box
    	...
    	title="flipzon's book's section"                                    #gives the title to the msg box
