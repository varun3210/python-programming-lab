...
sum=0
while 1:
  msgbox("WELCOME,ENTER PROMO CODE AND GET 50% OFF.") #shows msg
  msgbox("PROMO CODE FOR 50% OFF is='NEWS50'.") #shows msg
  msg=("What  type you wanna eat ?")#shows msg
  title=("Craving something,Have Something.")
  choices=["Breakfast","Indian","Chinese","Italian"]
  choice=choicebox(msg,title,choices)
  if choice=="Breakfast":
        msg1=("What  type you wanna eat,Choose a hotel ?") #shows msg
        ...
        if choice1=="A1 Pizza":
           msg10=("Select your meal.") #shows msg
           title10=("A1 Pizza") 
           ...
           if choice10=="veg cheese Pizza":
              ...
              if choice100=="ORDER":
                     ...
                     if choice1000=="NEWS50":
                        ...
                        msgbox=("wrong Promo code") #shows msg
                        msg10000=("Are you sure you wanna Order.You will have to pay actual price.") #shows msg
                        title10000=("Be sure!")
